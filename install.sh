...
alias 'mkdir=mkdir -p'
alias 'rc=nano /data/data/com.termux/files/usr/etc/bash.bashrc && source /data/data/com.termux/files/usr/etc/bash.bashrc'" >> /data/data/com.termux/files/usr/etc/bash.bashrc
